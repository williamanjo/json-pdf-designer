...
// A name given by the person (`page.name`) is DATA and comes out as it is;
// only the positional fallback label is interface, and it comes from the
// shell's dictionary — the same text the page's tab shows
