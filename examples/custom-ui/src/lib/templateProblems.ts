...
// it is. The fallback is a UI label, and it comes from the shared `pageLabel`
// (src/i18n.ts), which takes the word "page" from THE PACKAGE's dictionary —
// the same one the shell's tabs (PageTabs) and the property panel's "Page" tab use.
