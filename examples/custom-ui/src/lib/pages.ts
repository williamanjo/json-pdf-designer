...
// Todo Template manipulado por este example passa por aqui antes de virar
// estado — garante `pages` sempre presente e não-vazio, mesmo pra um
...
// Designer já toleram `pages` ausente sozinhos, mas a UI de abas precisa de
// um array pra iterar.
