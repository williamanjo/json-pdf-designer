...
// `page.name` é DADO (nome que a pessoa deu à página) e sai como está nos
// dois idiomas; só o rótulo POSICIONAL de fallback é UI, e ele sai do nosso
// dicionário — o mesmo que as abas de página usam, pra não haver "Página 2"
// numa e "Page 2" na outra.
