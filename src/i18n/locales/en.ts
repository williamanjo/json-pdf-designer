...
export const en = {
  ...
  expressionErrors: {
    ...
    unclosedBracket: () => "Unclosed [ in the path",
    emptySegment: () => "Empty path segment — [] has nothing in it",
    spaceInSegment: () =>
      'A path segment with a space has to be quoted: write ["my key"], not [my key]',
