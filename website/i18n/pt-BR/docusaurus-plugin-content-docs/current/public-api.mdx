...
segmentFor(key) => string                  // o segmento sozinho: "[id]"
...
// Zoom do canvas — contexto PRÓPRIO, então só quem lê re-renderiza
useDesignerZoom()                          // { zoom, min, max, step, setZoom, zoomIn, zoomOut, reset, fitWidth, fitHeight, viewportRef }
clampZoom(n), ZOOM_MIN, ZOOM_MAX, ZOOM_STEP // os limites que o canvas usa; clampZoom transforma NaN em 1
type DesignerZoomValue
// <DesignerCanvas hideZoombar /> tira a barra padrão — ver Compondo o Designer
